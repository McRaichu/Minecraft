...
public class FlyNodeProcessor extends NodeProcessor
{
    ...
    public int func_176164_a(PathPoint[] path, Entity entity, PathPoint p_176164_3_, PathPoint p_176164_4_, float p_176164_5_)
    {
        int i = 0;
        ...
        for (int k = 0; k < j; ++k)
        {
            ...
            PathPoint pathpoint2 = this.func_176185_a(entity, p_176164_3_.xCoord + enumfacing.getFrontOffsetX(), p_176164_3_.yCoord + enumfacing.getFrontOffsetY(), p_176164_3_.zCoord + enumfacing.getFrontOffsetZ());

            
            
            if (pathpoint2 != null && !pathpoint2.visited && pathpoint2.distanceTo(p_176164_4_) < p_176164_5_ && pathpoint2.distanceTo(new PathPoint((int)entity.posX, (int)entity.posY, (int)entity.posZ)) < 8.0F)
            {
