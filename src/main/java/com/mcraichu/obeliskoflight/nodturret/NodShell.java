...
public class NodShell extends EntityThrowable {
	...
	public NodShell(World worldIn, EntityLivingBase entity) {
	...
	public NodShell(World worldIn, double par1, double par2, double par3) {
	...
	public NodShell(World worldIn, boolean isHoming, Entity target) {
		super(worldIn);
		this.target = target;
