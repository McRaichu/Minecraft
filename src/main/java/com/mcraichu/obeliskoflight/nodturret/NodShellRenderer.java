...
public class NodShellRenderer extends Render {
	
	private static final ResourceLocation shellTextures = new ResourceLocation(Reference.MODID+ ":textures/entity/shell.png");
	
	protected NodShellRenderer(RenderManager renderManager) {
		super(renderManager);
	}

	public void renderRocket(NodShell par1EntityRocket, double par2, double par4, double par6, float par8, float par9) {
	...
	protected ResourceLocation getRocketTextures(NodShell par1EntityRocket) {
	 ...
	 */
	 protected ResourceLocation getEntityTexture(Entity par1Entity) {
		return this.getRocketTextures((NodShell) par1Entity);
	}
	 ...
	 */
	 ...
	 public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
			 this.renderRocket((NodShell) par1Entity, par2, par4, par6, par8, par9);
	 }
}
