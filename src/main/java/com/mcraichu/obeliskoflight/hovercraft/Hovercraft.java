...
public class Hovercraft extends Entity{
    ...
    private double boatOffsetY = 0.0;
	
	public static String unl_name = "hovercraft";
	
	public Hovercraft(World worldIn) {
		super(worldIn);
	...
	public Hovercraft(World worldIn, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(worldIn);
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            else
            {
                ...
                if (flag || this.getDamageTaken() > 40.0F)
                {
                    ...
                    if (!flag)
                    {
                    	this.dropItem(StartupCommon.item_hovercraft, 1);
    ...
    public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_)
    {
        ...
        else
        {
            if (this.isBoatEmpty)
            {
                this.boatPosRotationIncrements = p_180426_9_ + 9;
            }
            else
            {
                double d3 = p_180426_1_ - this.posX;
                double d4 = p_180426_3_ - this.posY  + this.boatOffsetY;
                ...
                this.boatPosRotationIncrements = 7;
            }

            this.boatX = p_180426_1_;
            this.boatY = p_180426_3_  + this.boatOffsetY;
...
//            	this.moveEntity(0, this.motionY + 0.25, 0);
//            	this.moveEntity(this.motionX, this.motionY, this.motionZ);
    ...
    protected void func_180433_a(double p_180433_1_, boolean p_180433_3_, Block p_180433_4_, BlockPos p_180433_5_)
    {
        if (p_180433_3_)
        {
            if (this.fallDistance > 3.0F)
            {
                ...
                {
                    this.setDead();
                    this.dropItemWithOffset(new ItemHovercraft(), 1, 0.0F);
