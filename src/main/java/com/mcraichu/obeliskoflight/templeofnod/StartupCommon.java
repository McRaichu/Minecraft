...
public class StartupCommon {
	...
	public static TempleOfNod templeOfNod;
	
	public static void preInitCommon()
	{
		templeOfNod = (TempleOfNod)(new TempleOfNod(Material.rock).setUnlocalizedName(TempleOfNod.unl_name));
		GameRegistry.registerBlock(templeOfNod, TempleOfNod.unl_name);
//		GameRegistry.registerTileEntity(TileEntityRefinery.class, TempleOfNod.unl_name + "_te");
	}
